...
class SandhiTest(unittest.TestCase):
    def test_number_in_text(self):
        text = u"அவள் ஒரு தேவதை - 5 அப்படியே தலையில் மாவு கொட்டியது"
        out,_ = check_sandhi(text)
        otext = u" ".join(out)
        self.assertEqual(otext,u'அவள் ஒரு தேவதை - 5 அப்படியே தலையில் மாவு கொட்டியது')
        self.assertTrue( '5' in otext )
